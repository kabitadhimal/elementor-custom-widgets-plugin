<?php
/*
Plugin Name: Elementor Recent Posts
Plugin URI: http://mehimali.com.np/
Description: Creates Recent Posts
Author: Kabita
Version: 1.0
...
final class App_Elementor_Recent_Posts {
    ...
    public function init_widgets() {
        ...
        require_once( __DIR__ . '/widgets/App-recent-posts-widget.php' );

        // Register widget
        \Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \App_Recent_Posts_Widget() );
...
App_Elementor_Recent_Posts::instance();